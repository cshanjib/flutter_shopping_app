...
import '../ui/bored/data/provider/bored_api_provider.dart' as _i8;
...
import '../ui/item/data/provider/product_item_provider.dart' as _i9;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i7.ProductItemCubit>(
      () => _i7.ProductItemCubit(get<_i6.ProductItemRepository>()));
  gh.singleton<_i8.BoaredApiProvider>(_i8.BoaredRealApiProvider());
  gh.singleton<_i8.BoaredApiProvider>(_i8.BoaredMockApiProvider(),
      instanceName: 'mock');
  gh.singleton<_i4.BoredRepository>(
      _i4.BoredRepository(get<_i8.BoaredApiProvider>()));
  gh.singleton<_i9.ProductItemProvider>(_i9.MockProductItemProvider(),
      instanceName: 'mock');
  gh.singleton<_i9.ProductItemProvider>(_i9.RealProductItemProvider());
  gh.singleton<_i6.ProductItemRepository>(_i6.ProductItemRepository(
      get<_i9.ProductItemProvider>(instanceName: 'mock')));
  return get;
}
